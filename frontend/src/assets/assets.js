...
export const jobsData = [
  ...
  },
  {
    ...
    description: `
        <p>Join our dynamic team as a <strong>MERN Stack Developer</strong>! In this role, you’ll work with <strong>MongoDB, Express, React, and Node.js</strong> to develop cutting-edge full-stack applications. You'll play a critical role in designing and implementing web applications, ensuring the best user experience. If you're passionate about web development, this is your chance to grow with us!</p>

        <h2><strong>Key Responsibilities 💻</strong></h2>
        <ol>
            <li>Develop and maintain full-stack web applications using the <strong>MERN stack</strong> (MongoDB, Express, React, Node.js).</li>
            <li>Collaborate with backend developers to design and implement scalable API services.</li>
            <li>Ensure applications are optimized for <strong>speed</strong> and <strong>scalability</strong>.</li>
            <li>Write clean, efficient, and maintainable code.</li>
            <li>Work closely with cross-functional teams to deliver high-quality features in an agile environment.</li>
        </ol>

        <h2><strong>Skills Required 🛠️</strong></h2>
        <ol>
            <li>Experience with the <strong>MERN stack</strong> (MongoDB, Express, React, Node.js).</li>
            <li>Strong proficiency in <strong>JavaScript (ES6+)</strong>, <strong>HTML</strong>, and <strong>CSS</strong>.</li>
            <li>Familiarity with <strong>RESTful APIs</strong> and integration with frontend applications.</li>
            <li>Experience with version control tools like <strong>Git</strong> and <strong>GitHub</strong>.</li>
            <li>Strong problem-solving skills and the ability to debug and troubleshoot issues efficiently.</li>
        </ol>
  ...
  },
  {
    ...
    companyId: {
      ...
      image: company_icon, // Ensure `company_icon` is defined or imported
    },
    description: `
        <p>Join our innovative team as a <strong>React Developer</strong>! In this role, you’ll work with cutting-edge technologies to build dynamic and responsive user interfaces. You'll play a key role in designing and implementing frontend solutions that deliver exceptional user experiences. If you're passionate about React and modern web development, this is your chance to shine! 🌟</p>

        <h2><strong>Key Responsibilities 💻</strong></h2>
        <ol>
            <li>Develop and maintain user-facing features using <strong>React.js</strong>.</li>
            <li>Collaborate with designers and backend developers to create seamless and intuitive user interfaces.</li>
            <li>Optimize components for maximum performance across a variety of devices and browsers.</li>
            <li>Write clean, reusable, and maintainable code following best practices.</li>
            <li>Participate in code reviews and contribute to a culture of continuous improvement.</li>
        </ol>

        <h2><strong>Skills Required 🛠️</strong></h2>
        <ol>
            <li>Strong proficiency in <strong>React.js</strong> and its core principles.</li>
            <li>Experience with state management libraries like <strong>Redux</strong> or <strong>Context API</strong>.</li>
            <li>Familiarity with modern frontend build pipelines and tools (e.g., <strong>Webpack</strong>, <strong>Babel</strong>).</li>
            <li>Knowledge of RESTful APIs and integrating them with frontend applications.</li>
            <li>Strong problem-solving skills and attention to detail.</li>
        </ol>

        <h2><strong>Why Join Us? 🌟</strong></h2>
        <ul>
            <li>Work with a creative and collaborative team. 👩‍💻👨‍💻</li>
            <li>Opportunities to work on exciting and impactful projects. 🚀</li>
            <li>Competitive salary and comprehensive benefits. 💰</li>
            <li>Flexible working hours and remote work options. 🏡</li>
            <li>Regular team events and professional development opportunities. 🎉</li>
        </ul>
    `,
  ...
  },
  {
    ...
    description: `
        <p>Join our team as a <strong>Frontend Developer</strong> and help us create stunning user interfaces! You’ll work with modern frameworks like <strong>React</strong> and <strong>Vue.js</strong> to build responsive and interactive web applications. 🌐</p>

        <h2><strong>Key Responsibilities 💻</strong></h2>
        <ol>
            <li>Develop and maintain user-facing features using modern JavaScript frameworks.</li>
        ...
        <h2><strong>Skills Required 🛠️</strong></h2>
        <ol>
            <li>Proficiency in <strong>HTML</strong>, <strong>CSS</strong>, and <strong>JavaScript</strong>.</li>
            <li>Experience with <strong>React</strong> or <strong>Vue.js</strong>.</li>
            <li>Familiarity with version control systems like <strong>Git</strong>.</li>
            <li>Strong problem-solving skills and attention to detail.</li>
  ...
  },
  {
    ...
    description: `
        <p>We’re looking for a <strong>Backend Developer</strong> to join our team and build robust server-side applications. You’ll work with technologies like <strong>Node.js</strong>, <strong>Python</strong>, and <strong>Django</strong> to create scalable and efficient backend systems. 🚀</p>

        <h2><strong>Key Responsibilities 💻</strong></h2>
        <ol>
            <li>Design and implement backend services and APIs.</li>
            <li>Optimize database queries and ensure high performance.</li>
        ...
        <h2><strong>Skills Required 🛠️</strong></h2>
        <ol>
            <li>Proficiency in <strong>Node.js</strong>, <strong>Python</strong>, or <strong>Java</strong>.</li>
            <li>Experience with databases like <strong>MySQL</strong> or <strong>MongoDB</strong>.</li>
        ...
        <h2><strong>Why Join Us? 🌟</strong></h2>
        <ul>
            <li>Work on challenging and impactful projects. 🌍</li>
  ...
  },
  {
    ...
    description: `
        <p>Join our AI team and work on cutting-edge machine learning models! As an <strong>AI Engineer</strong>, you’ll develop and deploy AI solutions that solve real-world problems. 🧠</p>
        ...
        <ol>
            ...
            <li>Stay updated with the latest AI trends and technologies.</li>
        </ol>

        <h2><strong>Skills Required 🛠️</strong></h2>
        <ol>
            <li>Proficiency in <strong>Python</strong> and machine learning libraries like <strong>TensorFlow</strong> or <strong>PyTorch</strong>.</li>
            <li>Experience with data preprocessing and analysis.</li>
            <li>Knowledge of cloud platforms like <strong>AWS</strong> or <strong>Google Cloud</strong>.</li>
  ...
  },
  {
    ...
    companyId: {
      _id: "670e4d25ca9fda8f1bf359b9",
      name: "Productify Inc.",
      email: "info@productify.com",
      image: company_icon,
    },
    description: `
        <p>We’re hiring a <strong>Product Manager</strong> to lead the development of our innovative products. You’ll work closely with cross-functional teams to deliver high-quality solutions that meet customer needs. 🚀</p>

        <h2><strong>Key Responsibilities 💻</strong></h2>
        <ol>
            <li>Define product vision and strategy.</li>
            <li>Collaborate with engineering, design, and marketing teams.</li>
            <li>Prioritize features and manage the product roadmap.</li>
            <li>Conduct market research and analyze customer feedback.</li>
            <li>Ensure timely delivery of product releases.</li>
        </ol>
  ...
  },
  {
    ...
    description: `
        <p>Join our data team as a <strong>Data Analyst</strong> and help us turn data into actionable insights! You’ll analyze large datasets, create visualizations, and support decision-making processes. 📊</p>

        <h2><strong>Key Responsibilities 💻</strong></h2>
        <ol>
            <li>Analyze and interpret complex datasets.</li>
            <li>Create reports and dashboards using tools like <strong>Tableau</strong> or <strong>Power BI</strong>.</li>
            <li>Collaborate with stakeholders to understand business needs.</li>
            <li>Identify trends and patterns in data.</li>
            <li>Present findings to teams and management.</li>
        </ol>

        <h2><strong>Skills Required 🛠️</strong></h2>
        <ol>
            <li>Proficiency in <strong>SQL</strong> and data analysis tools.</li>
  ...
  },
  {
    ...
    companyId: {
      _id: "670e4d25ca9fda8f1bf359b9",
      name: "CloudOps Inc.",
      email: "info@cloudops.com",
      image: company_icon,
    },
    description: `
        <p>We’re looking for a <strong>DevOps Engineer</strong> to help us build and maintain scalable cloud infrastructure. You’ll work with tools like <strong>Docker</strong>, <strong>Kubernetes</strong>, and <strong>AWS</strong> to ensure seamless deployments. 🚀</p>

        <h2><strong>Key Responsibilities 💻</strong></h2>
        <ol>
            <li>Design and implement CI/CD pipelines.</li>
            <li>Manage cloud infrastructure and ensure high availability.</li>
            <li>Automate deployment and monitoring processes.</li>
            <li>Collaborate with development and operations teams.</li>
            <li>Ensure security and compliance of cloud environments.</li>
        </ol>

        <h2><strong>Skills Required 🛠️</strong></h2>
        <ol>
            <li>Proficiency in <strong>AWS</strong>, <strong>Azure</strong>, or <strong>Google Cloud</strong>.</li>
            <li>Experience with <strong>Docker</strong> and <strong>Kubernetes</strong>.</li>
            <li>Strong scripting skills in <strong>Bash</strong> or <strong>Python</strong>.</li>
            <li>Familiarity with infrastructure as code tools like <strong>Terraform</strong>.</li>
            <li>Excellent problem-solving and troubleshooting skills.</li>
        </ol>

        <h2><strong>Why Join Us? 🌟</strong></h2>
        <ul>
            <li>Work on cutting-edge cloud projects. ☁️</li>
            <li>Competitive salary and benefits. 💰</li>
            <li>Flexible working hours and remote options. 🏡</li>
            <li>Opportunities for professional growth. 📈</li>
        </ul>
  ...
  },
  {
    ...
    companyId: {
      _id: "670e4d25ca9fda8f1bf359b9",
      name: "DesignCraft Ltd.",
      email: "info@designcraft.com",
      image: company_icon,
    },
    description: `
        <p>Join our design team as a <strong>UI/UX Designer</strong> and create beautiful, user-friendly interfaces! You’ll work with tools like <strong>Figma</strong> and <strong>Sketch</strong> to design intuitive and engaging experiences. 🎨</p>
        ...
        <ol>
            ...
            <li>Ensure consistency across all design elements.</li>
            <li>Stay updated with the latest design trends and tools.</li>
        </ol>

        <h2><strong>Skills Required 🛠️</strong></h2>
        <ol>
            <li>Proficiency in <strong>Figma</strong>, <strong>Sketch</strong>, or <strong>Adobe XD</strong>.</li>
            <li>Strong understanding of user-centered design principles.</li>
  ...
  },
  {
    ...
    description: `
        <p>We’re hiring a <strong>Cybersecurity Analyst</strong> to protect our systems from cyber threats. You’ll monitor networks, analyze vulnerabilities, and implement security measures to safeguard our data. 🔒</p>

        <h2><strong>Key Responsibilities 💻</strong></h2>
        <ol>
            <li>Monitor network traffic for suspicious activity.</li>
            <li>Conduct vulnerability assessments and penetration testing.</li>
            <li>Implement security measures to protect systems.</li>
            <li>Respond to and resolve security incidents.</li>
            <li>Stay updated with the latest cybersecurity trends.</li>
        </ol>

        <h2><strong>Skills Required 🛠️</strong></h2>
        <ol>
            <li>Proficiency in cybersecurity tools and technologies.</li>
            <li>Experience with firewalls, IDS/IPS, and SIEM systems.</li>
            <li>Strong understanding of network protocols and security.</li>
            <li>Excellent problem-solving and analytical skills.</li>
            <li>Relevant certifications like <strong>CISSP</strong> or <strong>CEH</strong>.</li>
        </ol>

        <h2><strong>Why Join Us? 🌟</strong></h2>
        <ul>
            <li>Work on critical security projects. 🚀</li>
            <li>Competitive salary and benefits. 💰</li>
            <li>Flexible working hours and remote options. 🏡</li>
            <li>Opportunities for professional growth. 📈</li>
        </ul>
